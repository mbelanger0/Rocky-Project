...
void loop()
{
  ...
  if (cur_time - start_time > 3000)
    ...
    motors.setSpeeds((int16_t) (200), (int16_t)(200));     // magnitude of step = 300 *************
  ...
  if ((cur_time - prev_print_time > 5) && cur_time - start_time < 3000) // print data every 20 ms
  {
    Serial.print((uint8_t)(measured_speedL*100));  // speed in cm/s
    Serial.print(",");
    Serial.print((uint8_t)(measured_speedR*100));  // speed in cm/s
    Serial.print(";");
